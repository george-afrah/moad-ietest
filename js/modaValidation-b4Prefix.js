...
//base url building:
let getOTPURL = `https://test.directatrading.com/trading/otpnewc?TEL=${TLCellulare}&COGN=${Cognome}&NOME=${Nome}`;
...
the3formValues.forEach(inputs => {
    inputs.addEventListener("change", function () {
        ...
        // Update URL:
        getOTPURL = `https://test.directatrading.com/trading/otpnewc?TEL=${TLCellulare}&COGN=${Cognome}&NOME=${Nome}`;       
    });
});
